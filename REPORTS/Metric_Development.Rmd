...
comp <- datTest[
    i = TRUE, 
    list(Inspection_Date_BAU   = Inspection_Date[order(Inspection_Date)],
         criticalFound_BAU     = criticalFound[order(Inspection_Date)],
         Inspection_Date_Model = Inspection_Date[order(-glm_pred)], 
         criticalFound_Model   = criticalFound[order(-glm_pred)])]
comp
...
comp_summary <- comp[
    ...
    keyby = list(Inspection_Date = Inspection_Date_BAU)]
comp_summary
```
...
# 
# 
# total_violations <- comp_summary[ , sum(Crit_Violations_BAU)]
# 
# comp_summary[ , Best_Possible := Total_Inspections]
# 
# 
# cumsum_inspections <- comp_summary[ , cumsum(Total_Inspections)]
# cumsum_inspections[ which(
